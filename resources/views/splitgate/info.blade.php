    ...
    <body>
        <div class="container">
            <form id="generator" action="">
                ...
                <div class="tab">User info: (Find your Steam64 ID here: <a href="https://steamid.xyz" target="blank">steamid.xyz</a>)
                    <p><input name="username" placeholder="Xbox gamertag / PSN / Steam ID" oninput="this.className = ''"></p>
                    <p>
